    	...
    	/* Drive Controller */
        {
            /* Drive */
            {
            	/* Ultrasonic */
            	{
            		...
            		this.bind(new Binding(modules.getModule("Drive").getAction("Setpoint"), driver.buttons.B));
            		this.fill(new DataWire(modules.getModule("Drive").getAction("Setpoint"), "distance", 7));
            	}
            	/* Dynamic Drive */
            	{
